...
export const GoogleIcon = ({ size = 24 }: { size: number }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_2514_11444)">
        <path
        ...
        />
        <path
          d="M24 12H44.7812C42.6754 8.35138 39.6461 5.3215 35.9979 3.215C32.3496 1.10851 28.2111 -0.000339647 23.9984 -4.57179e-05C19.7857 0.000248211 15.6473 1.10967 11.9994 3.21668C8.35149 5.32368 5.3226 8.35399 3.2173 12.0029L13.6079 30L13.6172 29.9976C12.5602 28.1749 12.0024 26.1057 12 23.9987C11.9977 21.8916 12.5508 19.8212 13.6037 17.9961C14.6566 16.171 16.1721 14.6557 17.9973 13.603C19.8225 12.5503 21.893 11.9974 24 12Z"
          fill="url(#paint0_linear_2514_11444)"
        />
        <path
        ...
        />
        <path
          d="M34.3913 30.0029L24.0007 48C28.2134 48.0006 32.352 46.892 36.0003 44.7858C39.6487 42.6796 42.6782 39.6499 44.7843 36.0015C46.8904 32.353 47.9987 28.2144 47.998 24.0017C47.9972 19.789 46.8874 15.6508 44.78 12.0031H23.9989L23.9964 12.0124C26.1034 12.0083 28.1743 12.5598 30.0003 13.6113C31.8262 14.6627 33.3427 16.177 34.3968 18.0014C35.4509 19.8258 36.0055 21.8958 36.0045 24.0029C36.0035 26.1099 35.4471 28.1795 34.3913 30.0029Z"
          fill="url(#paint1_linear_2514_11444)"
        />
        <path
          d="M13.6086 30.0031L3.218 12.006C1.11112 15.654 0.00183548 19.7924 0.00167848 24.0051C0.00152149 28.2178 1.1105 32.3563 3.2171 36.0045C5.32371 39.6526 8.35368 42.6818 12.0024 44.7875C15.651 46.8932 19.7898 48.0012 24.0025 48L34.3931 30.0029L34.3864 29.9961C33.3364 31.8229 31.8233 33.3405 29.9997 34.3961C28.1762 35.4517 26.1066 36.0078 23.9995 36.0085C21.8925 36.0092 19.8225 35.4545 17.9982 34.4001C16.1739 33.3458 14.6599 31.8292 13.6086 30.0031Z"
          fill="url(#paint2_linear_2514_11444)"
        />
      </g>
      <defs>
        <linearGradient
          id="paint0_linear_2514_11444"
          x1="3.2173"
          y1="15"
          x2="44.7812"
          y2="15"
