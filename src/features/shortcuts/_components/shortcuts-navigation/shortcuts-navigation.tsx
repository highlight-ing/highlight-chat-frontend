...
import { Global, Setting } from 'iconsax-react'
    ...
    <div className="flex flex-col h-full">
      ...
      <ScrollArea className="h-[calc(100vh-200px)]">
        <div className="space-y-1 p-4">
          {/* Global Option */}
          <div className="flex items-center gap-3 rounded-2xl px-3 py-2 cursor-pointer hover:bg-light-5 mb-6">
          ...
          {applications.map((app) => (
            <div key={app.id} className="flex items-center gap-3 rounded-2xl px-3 py-2 cursor-pointer hover:bg-light-5">
              <div className="flex items-center gap-2">
                <div
