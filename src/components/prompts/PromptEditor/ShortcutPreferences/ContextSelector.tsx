...
export default function ContextSelector() {
  const { selectedApp } = usePromptEditorStore(); 
  ...
  return (
    <div className="flex flex-col space-y-3 rounded-2xl bg-[#222222] p-3">
      <div className="flex items-center justify-between">
        ...
        <ToggleSwitch checked={isEnabled} onToggle={setIsEnabled} />
      </div>
          ...
          {contextOptions.map((option) => (
            ...
            >
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-center h-7 w-7 rounded-md p-1.5 border border-[0.25px] border-[#333333]"
                  style={{
