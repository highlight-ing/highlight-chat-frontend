...
export const AgentModeIcon = ({ size = 24 }: IconPropTypes) => {
  return (
    <svg width={size} height={size} viewBox="0 0 250 250" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M187.194 45H63.8065C60.5948 45 58 47.5695 58 50.75V169.344C58 172.524 60.5948 175.094 63.8065 175.094H187.194C190.405 175.094 193 172.524 193 169.344V50.75C193 47.5695 190.405 45 187.194 45ZM87.0323 92.4375C87.0323 86.4898 91.9133 81.6562 97.9194 81.6562C103.925 81.6562 108.806 86.4898 108.806 92.4375C108.806 98.3852 103.925 103.219 97.9194 103.219C91.9133 103.219 87.0323 98.3852 87.0323 92.4375ZM154.532 137C154.532 137.791 153.879 138.438 153.081 138.438H97.9194C97.121 138.438 96.4677 137.791 96.4677 137V126.219C96.4677 125.428 97.121 124.781 97.9194 124.781H153.081C153.879 124.781 154.532 125.428 154.532 126.219V137ZM153.081 103.219C147.075 103.219 142.194 98.3852 142.194 92.4375C142.194 86.4898 147.075 81.6562 153.081 81.6562C159.087 81.6562 163.968 86.4898 163.968 92.4375C163.968 98.3852 159.087 103.219 153.081 103.219ZM177.577 188.75H73.4234C70.9194 188.75 68.8871 191.32 68.8871 194.5V204.562C68.8871 205.353 69.3952 206 70.0121 206H180.97C181.587 206 182.095 205.353 182.095 204.562V194.5C182.113 191.32 180.081 188.75 177.577 188.75Z"
        fill="#fff"
      />
    </svg>
  )
