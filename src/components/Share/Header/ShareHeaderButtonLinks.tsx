...
const shareButtonClass =
  'px-4 py-[6px] inline-flex items-center border border-tertiary rounded-[10px] text-xs font-medium text-secondary hover:text-primary hover:border-primary transition-colors transition-border duration-300 ease-in-out'
