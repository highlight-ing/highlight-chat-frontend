...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    // Text styles
    'dark:text-white forced-colors:text-[CanvasText] text-left text-base/6 text-zinc-950 sm:text-sm/6',
    // Focus
    ...
    // Icons
    '[&>[data-slot=icon]]:size-5 [&>[data-slot=icon]]:sm:size-4 [&>[data-slot=icon]]:col-start-1 [&>[data-slot=icon]]:row-start-1 [&>[data-slot=icon]]:-ml-0.5 [&>[data-slot=icon]]:mr-2.5 sm:[&>[data-slot=icon]]:mr-2',
    ...
    // Avatar
    '[&>[data-slot=avatar]]:size-6 sm:[&>[data-slot=avatar]]:size-5 [&>[data-slot=avatar]]:-ml-1 [&>[data-slot=avatar]]:mr-2.5 sm:[&>[data-slot=avatar]]:mr-2',
  )
