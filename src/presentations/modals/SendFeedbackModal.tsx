      ...
      <div className="left-0 flex flex-col justify-start gap-4">
        ...
        <div className="flex flex-col gap-1">
          <p className="text-xs text-gray-400">
            ...
            future improvements to our models. We anonymize your inputs and outputs from your conversation and user ID
            to use them for training and improving our experience.{' '}
          </p>
