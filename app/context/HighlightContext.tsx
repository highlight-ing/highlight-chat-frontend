...
export const HighlightContextContext = createContext<HighlightContextContextProps>({
  highlightContext: {} as HighlightContext,
  setHighlightContext: () => {}
})

export const HighlightContextContextProvider = ({ children }: { children: React.ReactNode }) => {
  const [highlightContext, setHighlightContext] = useState<HighlightContext | undefined>(undefined)

  return (
    <HighlightContextContext.Provider value={{ highlightContext, setHighlightContext }}>
      {children}
